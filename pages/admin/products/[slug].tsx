...
const ProductAdminPage: FC<Props> = ({ product }) => {
    ...
    const [isSaving, setIsServing] = useState(false)

    const { register, handleSubmit, formState: { errors }, getValues, setValue, watch } = useForm<FormDate>({
    ...
    const onSubmitProduct = async (form: FormDate) => {
